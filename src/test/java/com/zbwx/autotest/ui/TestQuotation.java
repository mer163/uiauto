...
public class TestQuotation extends BaseTest {
	...
	public void testSwitchCommodity() throws Exception{
		...
		ArrayList<String> price0 = BaseAction.position.getTextById("com.ylmall.app.ui:id/mogen_price");
		BaseAction.device.click(qPage1.commodity_Cu);
		ArrayList<String> price1 = BaseAction.position.getTextById("com.ylmall.app.ui:id/mogen_price");
	...
	public void testClickMessage() throws Exception{
		...
		QuotationPage qPage1 = new QuotationPage();
		BaseAction.device.click(qPage1.messageButton);
	...
	public void testK_lineSelectM5() throws Exception{
		...
		BaseAction.device.click(qp.k_M5);
	...
	public void testK_lineSelectM15() throws Exception{
		...
		qpPage.mOpenQuotationPage();
		QuotationPage qp = new QuotationPage();
		BaseAction.device.click(qp.k_M15);
		Assertion.VerityBoolean(BaseAction.position.waitForElement(ElementAttribs.RESOURCE_ID, "com.ylmall.app.ui:id/newcfd_my_charts_view5_1", 3000), true, "切换成功");
		BaseAction.mReturnHomePage();
	}
	...
	public void testK_lineSelectH1() throws Exception{
		...
		qpPage.mOpenQuotationPage();
		QuotationPage qp = new QuotationPage();
		BaseAction.device.click(qp.k_H1);
		Assertion.VerityBoolean(BaseAction.position.waitForElement(ElementAttribs.RESOURCE_ID, "com.ylmall.app.ui:id/newcfd_my_charts_view5_1", 3000), true, "切换成功");
		BaseAction.mReturnHomePage();
	}
	...
	public void testK_lineSelectD1() throws Exception{
		...
		qpPage.mOpenQuotationPage();
		QuotationPage qp = new QuotationPage();
		BaseAction.device.click(qp.k_D1);
		Assertion.VerityBoolean(BaseAction.position.waitForElement(ElementAttribs.RESOURCE_ID, "com.ylmall.app.ui:id/newcfd_my_charts_view5_1", 3000), true, "切换成功");
		BaseAction.mReturnHomePage();
	}
	...
	public void testK_lineSelectTimeshare() throws Exception{
		...
		BaseAction.device.click(qp.k_D1);
		Assertion.VerityBoolean(BaseAction.position.waitForElement(ElementAttribs.RESOURCE_ID, "com.ylmall.app.ui:id/newcfd_my_charts_view5_1", 3000), true, "切换成功");
		BaseAction.device.click(qp.k_Timeshare);
	...
	public void testClickOrder() throws Exception{
		...
		qpPage.mOpenQuotationPage();
		QuotationPage qp = new QuotationPage();
		BaseAction.device.click(qp.orderButton);
