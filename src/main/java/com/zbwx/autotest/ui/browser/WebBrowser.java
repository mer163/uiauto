...
import com.zbwx.autotest.ui.utils.WebElementLocator;
...
public abstract class WebBrowser {
	...
	public void takeScreenshot(String browsertype, String browserversion) {
		...
		String screenPath = WebPath.getReportSnapshotPath()
	...
	public WebElement findElement(String locator) {
		final WebElementLocator el = WebElementLocator.create(locator);
...
//	}
	 ...
	 */
	public void verifyElementText(String locator, String text, WebMatchMode mode, boolean matched) {
		WebElement element = findElement(locator);
	 ...
	 *            匹配模式: ExactMatch=精确匹配 PartialMatch=部分匹配 RegexMatch=正则表达式匹配
	 */
	public void verifyElementAttribute(String locator, String Attribute, String value, WebMatchMode mode,
			boolean matched) {
		WebElement element = findElement(locator);
	 ...
	 *            匹配模式: ExactMatch=精确匹配 PartialMatch=部分匹配 RegexMatch=正则表达式匹配
	 */
	public void verifyCurrentUrl(String text, WebMatchMode mode, boolean matched) {
	 ...
	 *            匹配模式: ExactMatch=精确匹配 PartialMatch=部分匹配 RegexMatch=正则表达式匹配
	 */
	public void verifyAlertText(String text, WebMatchMode mode, boolean matched) {
