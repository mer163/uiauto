...
public class WebCommonFunction {
    static WebTestCaseResult result = new WebTestCaseResult();
    ...
    public WebCommonFunction(WebBrowser driver) {
        super();
        this.driver = driver;
    }
     ...
     *
     */
    public WebTestCaseResult checkJsURLConnect() {
        String jsurl;
        String msg = "校验有错误： \r\n";
     ...
     *
     */
    public WebTestCaseResult checkCssURLConnect() {
        String cssurl;
        String msg = "校验有错误： \r\n";
        CloseableHttpResponse response = null;
     ...
     *
     */
    public WebTestCaseResult checkPicConnect() {
        String msg = "校验有错误： \r\n";
        boolean flag = true;
